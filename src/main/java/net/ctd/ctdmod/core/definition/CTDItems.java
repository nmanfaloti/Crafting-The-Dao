 ...
 * <p>
 * Items are registered via {@link #DR} and stored as {@link ItemDefinition}s.
 * Use
 * {@link #item(String, ResourceLocation, Function)} or its overload to register
 * new items.
 */
public class CTDItems {
   ...
   * @param id      The {@link ResourceLocation} identifying the item (must use
   ...
   * @throws IllegalArgumentException If {@code id} does not belong to this mod's
   *                                  namespace.
   */
   ...
   *                this mod's namespace).
   * @param factory A factory that creates the item from {@link Item.Properties}.
   * @param group   The creative tab for this item, or {@code null} for none. Use
   *                {@link CTDCreativeTabIds#MAIN} or
   *                {@link CTDCreativeTabIds#ALCHEMY}.
   * @return A {@link ItemDefinition} containing the registered item.
   * @throws IllegalArgumentException If {@code id} does not belong to this mod's
   *                                  namespace.
   */
